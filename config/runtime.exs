...
#
#     PHX_SERVER=true bin/gofitback start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :gofitback, GofitbackWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :gofitback, Gofitback.Repo,
    ...
    # SSL configuration for Render (accepts self-signed certificates)
    ssl: true,
    ssl_opts: [
      verify: :verify_none
    ]
  ...
  #
  #     config :gofitback, Gofitback.Mailer,
