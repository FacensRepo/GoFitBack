...
#   - Ex: hexpm/elixir:1.17.2-erlang-26.2.5.2-debian-bullseye-20240904-slim
#
...
RUN apt-get update -y && \
  apt-get install -y libstdc++6 openssl libncurses5 locales ca-certificates curl net-tools iputils-ping \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/gofitback ./
